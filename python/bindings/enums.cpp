...
void init_enums(py::module_& m)
{
    ...
    // --- CellType ---
    py::enum_<OpenImpala::CellType>(m, "CellType",
        "Cell role within the computational domain.")
    ...
    // --- RawDataType ---
    py::enum_<OpenImpala::RawDataType>(m, "RawDataType",
        "Primitive data type and endianness for raw binary voxel files.")
    ...
    py::enum_<OpenImpala::EffectiveDiffusivityHypre::SolverType>(m, "EffDiffSolverType",
    ...
    // --- PhysicsType ---
    py::enum_<OpenImpala::PhysicsType>(m, "PhysicsType",
        "Physical quantity being computed.")
