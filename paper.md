...
![Architecture of OpenImpala. The I/O layer reads 3D voxel images into AMReX distributed data structures. The physics layer solves steady-state diffusion via HYPRE Krylov / algebraic multigrid solvers or AMReX MLMG (matrix-free geometric multigrid). The output layer exports tortuosity, effective diffusivity tensors, and microstructural metrics.\label{fig:architecture}](figure.png)
